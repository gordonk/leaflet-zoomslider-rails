L.TileLayer.Post = L.TileLayer.extend({
  ...
  _loadTile: function (tile, tilePoint) {
    ...
    tile.src     = this.getTileUrl(tilePoint, tile);
  ...
  _updateTileSrc: function (data, tile) {
    tile.src = "data:image/jpeg;base64," + data;
  }
